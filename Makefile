...
#
OBJS = server.o request.o segel.o client.o pcqueue.o
TARGET = server
...
server: server.o request.o segel.o pcqueue.o
	$(CC) $(CFLAGS) -o server server.o request.o segel.o pcqueue.o $(LIBS)
